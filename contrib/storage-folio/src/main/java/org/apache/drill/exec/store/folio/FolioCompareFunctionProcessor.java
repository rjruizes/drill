...
public class FolioCompareFunctionProcessor extends AbstractExprVisitor<Boolean, LogicalExpression, RuntimeException> {
  ...
  public static FolioCompareFunctionProcessor process(FunctionCall call) {
    String functionName = call.getName();
    LogicalExpression nameArg = call.args.get(0);
    LogicalExpression valueArg = call.args.size() == 2 ? call.args.get(1) : null;
    FolioCompareFunctionProcessor evaluator = new FolioCompareFunctionProcessor(functionName);
  ...
  public FolioCompareFunctionProcessor(String functionName) {
    this.success = false;
